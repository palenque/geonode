...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelDescription'
        db.create_table(u'dynamic_modeldescription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('layer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['layers.Layer'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'dynamic', ['ModelDescription'])

        # Adding model 'Field'
        db.create_table(u'dynamic_field', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fields', to=orm['dynamic.ModelDescription'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('original_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'dynamic', ['Field'])

        # Adding unique constraint on 'Field', fields ['model', 'name']
        db.create_unique(u'dynamic_field', ['model_id', 'name'])

        # Adding model 'Setting'
        db.create_table(u'dynamic_setting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'settings', to=orm['dynamic.Field'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'dynamic', ['Setting'])

        # Adding unique constraint on 'Setting', fields ['field', 'name']
        db.create_unique(u'dynamic_setting', ['field_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Setting', fields ['field', 'name']
        db.delete_unique(u'dynamic_setting', ['field_id', 'name'])

        # Removing unique constraint on 'Field', fields ['model', 'name']
        db.delete_unique(u'dynamic_field', ['model_id', 'name'])

        # Deleting model 'ModelDescription'
        db.delete_table(u'dynamic_modeldescription')

        # Deleting model 'Field'
        db.delete_table(u'dynamic_field')

        # Deleting model 'Setting'
        db.delete_table(u'dynamic_setting')
    ...
    models = {
        ...
        u'dynamic.modeldescription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layer': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['layers.Layer']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'dynamic.setting': {
        ...
        u'layers.layer': {
            ...
            'concave_hull': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'layer_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['layers.LayerType']", 'null': 'True', 'blank': 'True'}),
