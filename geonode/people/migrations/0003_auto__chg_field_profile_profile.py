...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.profile'
        db.alter_column(u'people_profile', 'profile', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Profile.profile'
        db.alter_column(u'people_profile', 'profile', self.gf('django.db.models.fields.TextField')())
