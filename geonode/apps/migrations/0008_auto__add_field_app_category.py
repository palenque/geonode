...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.category'
        db.add_column(u'apps_app', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.AppCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.category'
        db.delete_column(u'apps_app', 'category_id')
