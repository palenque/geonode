...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field public_layer_permissions on 'App'
        m2m_table_name = db.shorten_name(u'apps_app_public_layer_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('app', models.ForeignKey(orm[u'apps.app'], null=False)),
            ('layer', models.ForeignKey(orm[u'layers.layer'], null=False))
        ))
        db.create_unique(m2m_table_name, ['app_id', 'layer_id'])


    def backwards(self, orm):
        # Removing M2M table for field public_layer_permissions on 'App'
        db.delete_table(db.shorten_name(u'apps_app_public_layer_permissions'))
    ...
    models = {
        u'apps.app': {
            ...
            'public_layer_permissions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['layers.Layer']", 'symmetrical': 'False'}),
