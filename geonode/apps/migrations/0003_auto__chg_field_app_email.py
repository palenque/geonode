...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field members on 'App'
        m2m_table_name = db.shorten_name(u'apps_app_members')
        ...
        db.create_unique(m2m_table_name, ['app_id', 'profile_id'])


        # Changing field 'App.email'
        db.alter_column(u'apps_app', 'email', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):
        # Removing M2M table for field members on 'App'
        db.delete_table(db.shorten_name(u'apps_app_members'))


        # Changing field 'App.email'
        db.alter_column(u'apps_app', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        u'apps.app': {
            ...
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['people.Profile']", 'symmetrical': 'False'}),
