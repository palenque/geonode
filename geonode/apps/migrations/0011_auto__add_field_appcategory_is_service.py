...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppCategory.is_service'
        db.add_column(u'apps_appcategory', 'is_service',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppCategory.is_service'
        db.delete_column(u'apps_appcategory', 'is_service')
