...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.short_description'
        db.add_column(u'apps_app', 'short_description',
    ...
    def backwards(self, orm):
        # Deleting field 'App.short_description'
        db.delete_column(u'apps_app', 'short_description')
