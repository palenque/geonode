...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceBase.creator'
        db.add_column(u'base_resourcebase', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_resource', null=True, to=orm['people.Profile']),
                      keep_default=False)

        # Adding field 'ResourceBase.app'
        db.add_column(u'base_resourcebase', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.App'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceBase.creator'
        db.delete_column(u'base_resourcebase', 'creator_id')

        # Deleting field 'ResourceBase.app'
        db.delete_column(u'base_resourcebase', 'app_id')
