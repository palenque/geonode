...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InternalLink'
        db.create_table(u'base_internallink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='internal_links_forward_set', to=orm['base.ResourceBase'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='internal_links_backward_set', to=orm['base.ResourceBase'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'base', ['InternalLink'])


    def backwards(self, orm):
        # Deleting model 'InternalLink'
        db.delete_table(u'base_internallink')
    ...
    models = {
        ...
        u'base.internallink': {
            'Meta': {'object_name': 'InternalLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'internal_links_forward_set'", 'to': u"orm['base.ResourceBase']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'internal_links_backward_set'", 'to': u"orm['base.ResourceBase']"})
        },
        u'base.license': {
