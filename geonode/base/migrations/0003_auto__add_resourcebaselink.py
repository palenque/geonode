...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceBaseLink'
        db.create_table(u'base_resourcebaselink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resourcelinks_forward', to=orm['base.ResourceBase'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resourcelinks_backward', to=orm['base.ResourceBase'])),
            ('link_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'base', ['ResourceBaseLink'])


    def backwards(self, orm):
        # Deleting model 'ResourceBaseLink'
        db.delete_table(u'base_resourcebaselink')
    ...
    models = {
        ...
        u'base.resourcebaselink': {
            'Meta': {'object_name': 'ResourceBaseLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resourcelinks_forward'", 'to': u"orm['base.ResourceBase']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resourcelinks_backward'", 'to': u"orm['base.ResourceBase']"})
        },
