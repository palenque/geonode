...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.preserved'
        db.add_column(u'layers_attribute', 'preserved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.preserved'
        db.delete_column(u'layers_attribute', 'preserved')
    ...
    models = {
        ...
        u'layers.attribute': {
            ...
            'preserved': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'layers.metadatatype': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'layer_metadata_type_attribute'", 'to': u"orm['eav.Attribute']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_precalculated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
