...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'layers_attribute', 'field',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['layers.AttributeType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.field'
        db.delete_column(u'layers_attribute', 'field_id')
    ...
    models = {
        ...
        u'layers.attribute': {
            ...
            'field': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['layers.AttributeType']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
