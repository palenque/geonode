...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeType.is_precalculated'
        db.add_column(u'layers_attributetype', 'is_precalculated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AttributeType.sql_expression'
        db.add_column(u'layers_attributetype', 'sql_expression',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeType.is_precalculated'
        db.delete_column(u'layers_attributetype', 'is_precalculated')

        # Deleting field 'AttributeType.sql_expression'
        db.delete_column(u'layers_attributetype', 'sql_expression')
    ...
    models = {
        ...
        u'layers.attributetype': {
            ...
            'sql_expression': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'})
        },
        u'layers.layer': {
