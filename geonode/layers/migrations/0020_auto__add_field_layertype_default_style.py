...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.default_style'
        db.add_column(u'layers_layertype', 'default_style',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['layers.Style'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.default_style'
        db.delete_column(u'layers_layertype', 'default_style_id')
