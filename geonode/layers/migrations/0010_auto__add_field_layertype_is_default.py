...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.is_default'
        db.add_column(u'layers_layertype', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.is_default'
        db.delete_column(u'layers_layertype', 'is_default')
