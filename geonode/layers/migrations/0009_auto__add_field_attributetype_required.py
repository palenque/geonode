...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeType.required'
        db.add_column(u'layers_attributetype', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeType.required'
        db.delete_column(u'layers_attributetype', 'required')
