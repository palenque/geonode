...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeType.sql_magnitude'
        db.add_column(u'layers_attributetype', 'sql_magnitude',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeType.sql_magnitude'
        db.delete_column(u'layers_attributetype', 'sql_magnitude')
