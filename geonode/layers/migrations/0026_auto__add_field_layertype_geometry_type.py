...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.geometry_type'
        db.add_column(u'layers_layertype', 'geometry_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.geometry_type'
        db.delete_column(u'layers_layertype', 'geometry_type')
