...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.calculated_abstract'
        db.add_column(u'layers_layertype', 'calculated_abstract',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.calculated_abstract'
        db.delete_column(u'layers_layertype', 'calculated_abstract')
