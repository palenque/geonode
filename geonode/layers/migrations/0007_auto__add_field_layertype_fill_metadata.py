...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.fill_metadata'
        db.add_column(u'layers_layertype', 'fill_metadata',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.fill_metadata'
        db.delete_column(u'layers_layertype', 'fill_metadata')
