...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeType.label'
        db.add_column(u'layers_attributetype', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeType.label'
        db.delete_column(u'layers_attributetype', 'label')
