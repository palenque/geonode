...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.label'
        db.add_column(u'layers_layertype', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LayerType.description'
        db.add_column(u'layers_layertype', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.label'
        db.delete_column(u'layers_layertype', 'label')

        # Deleting field 'LayerType.description'
        db.delete_column(u'layers_layertype', 'description')
