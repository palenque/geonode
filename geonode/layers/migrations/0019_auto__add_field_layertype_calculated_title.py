...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.calculated_title'
        db.add_column(u'layers_layertype', 'calculated_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.calculated_title'
        db.delete_column(u'layers_layertype', 'calculated_title')
