...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.metadata_edited'
        db.add_column(u'layers_layer', 'metadata_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.metadata_edited'
        db.delete_column(u'layers_layer', 'metadata_edited')
