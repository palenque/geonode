...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeType.description'
        db.add_column(u'layers_attributetype', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeType.description'
        db.delete_column(u'layers_attributetype', 'description')
