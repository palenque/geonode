...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerType.show_category'
        db.add_column(u'layers_layertype', 'show_category',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerType.show_category'
        db.delete_column(u'layers_layertype', 'show_category')
