...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataType.is_precalculated'
        db.add_column(u'layers_metadatatype', 'is_precalculated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MetadataType.sql_expression'
        db.add_column(u'layers_metadatatype', 'sql_expression',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MetadataType.sql_magnitude'
        db.add_column(u'layers_metadatatype', 'sql_magnitude',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataType.is_precalculated'
        db.delete_column(u'layers_metadatatype', 'is_precalculated')

        # Deleting field 'MetadataType.sql_expression'
        db.delete_column(u'layers_metadatatype', 'sql_expression')

        # Deleting field 'MetadataType.sql_magnitude'
        db.delete_column(u'layers_metadatatype', 'sql_magnitude')
    ...
    models = {
        ...
        u'layers.attributetype': {
            ...
            'attribute_type': ('django.db.models.fields.CharField', [], {'default': "'xsd:string'", 'max_length': '50', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_precalculated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sql_expression': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'sql_magnitude': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'layers.layer': {
