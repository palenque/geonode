...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'layers_attributetype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('layer_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attribute_type_set', to=orm['layers.LayerType'])),
            ...
            ('magnitude', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'layers', ['AttributeType'])

        # Adding model 'LayerType'
        db.create_table(u'layers_layertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'layers', ['LayerType'])


    def backwards(self, orm):
        # Deleting model 'AttributeType'
        db.delete_table(u'layers_attributetype')

        # Deleting model 'LayerType'
        db.delete_table(u'layers_layertype')
