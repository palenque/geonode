...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.field'
        db.add_column(u'layers_attribute', 'field',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attribute.magnitude'
        db.add_column(u'layers_attribute', 'magnitude',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.field'
        db.delete_column(u'layers_attribute', 'field')

        # Deleting field 'Attribute.magnitude'
        db.delete_column(u'layers_attribute', 'magnitude')
