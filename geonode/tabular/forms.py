...
class DocumentCreateForm(TranslationModelForm):
    ...
    charset = forms.ChoiceField(label=_('Charset'), choices=CHARSETS, required=False)
    ...
    class Meta:
        ...
        labels = {
            'tabular_type': _('Type'),
            'has_header': _('Has header'),
            'quotechar': _('Quote Char'),
