...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tabular.delimiter'
        db.add_column(u'tabular_tabular', 'delimiter',
        ...
        # Adding field 'Tabular.charset'
        db.add_column(u'tabular_tabular', 'charset',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tabular.delimiter'
        db.delete_column(u'tabular_tabular', 'delimiter')

        # Deleting field 'Tabular.quote'
        db.delete_column(u'tabular_tabular', 'quote')

        # Deleting field 'Tabular.charset'
        db.delete_column(u'tabular_tabular', 'charset')
