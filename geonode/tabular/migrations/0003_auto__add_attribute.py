...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tabular_attribute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tabular', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attribute_set', to=orm['tabular.Tabular'])),
        ...
        db.send_create_signal(u'tabular', ['Attribute'])


    def backwards(self, orm):
        # Deleting model 'Attribute'
        db.delete_table(u'tabular_attribute')
    ...
    models = {
        ...
        u'tabular.attribute': {
            ...
            'tabular': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attribute_set'", 'to': u"orm['tabular.Tabular']"}),
