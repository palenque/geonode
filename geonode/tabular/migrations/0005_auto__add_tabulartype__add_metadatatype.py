...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TabularType'
        db.create_table(u'tabular_tabulartype', (
        ...
        db.send_create_signal(u'tabular', ['TabularType'])

        # Adding model 'MetadataType'
        db.create_table(u'tabular_metadatatype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tabular_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tabular.TabularType'])),
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tabular_metadata_type_attribute', to=orm['eav.Attribute'])),
        ))
        db.send_create_signal(u'tabular', ['MetadataType'])


    def backwards(self, orm):
        # Deleting model 'TabularType'
        db.delete_table(u'tabular_tabulartype')

        # Deleting model 'MetadataType'
        db.delete_table(u'tabular_metadatatype')
