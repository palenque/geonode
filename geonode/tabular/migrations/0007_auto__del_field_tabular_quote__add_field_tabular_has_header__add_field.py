...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tabular.quote'
        db.delete_column(u'tabular_tabular', 'quote')

        # Adding field 'Tabular.has_header'
        db.add_column(u'tabular_tabular', 'has_header',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Tabular.tabs'
        db.add_column(u'tabular_tabular', 'tabs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tabular.quotechar'
        db.add_column(u'tabular_tabular', 'quotechar',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tabular.quoting'
        db.add_column(u'tabular_tabular', 'quoting',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tabular.doblequote'
        db.add_column(u'tabular_tabular', 'doblequote',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tabular.escapechar'
        db.add_column(u'tabular_tabular', 'escapechar',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Tabular.delimiter'
        db.alter_column(u'tabular_tabular', 'delimiter', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Adding field 'Tabular.quote'
        db.add_column(u'tabular_tabular', 'quote',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Tabular.has_header'
        db.delete_column(u'tabular_tabular', 'has_header')

        # Deleting field 'Tabular.tabs'
        db.delete_column(u'tabular_tabular', 'tabs')

        # Deleting field 'Tabular.quotechar'
        db.delete_column(u'tabular_tabular', 'quotechar')

        # Deleting field 'Tabular.quoting'
        db.delete_column(u'tabular_tabular', 'quoting')

        # Deleting field 'Tabular.doblequote'
        db.delete_column(u'tabular_tabular', 'doblequote')

        # Deleting field 'Tabular.escapechar'
        db.delete_column(u'tabular_tabular', 'escapechar')


        # Changing field 'Tabular.delimiter'
        db.alter_column(u'tabular_tabular', 'delimiter', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        u'tabular.tabular': {
            ...
            'delimiter': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'doblequote': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'escapechar': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'quotechar': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'quoting': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'tabs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
