...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.attribute_type'
        db.add_column(u'tabular_attribute', 'attribute_type',
                      self.gf('django.db.models.fields.CharField')(default='xsd:string', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.attribute_type'
        db.delete_column(u'tabular_attribute', 'attribute_type')
