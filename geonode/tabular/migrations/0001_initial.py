...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tabular'
        db.create_table(u'tabular_tabular', (
            ...
            ('doc_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('doc_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'tabular', ['Tabular'])


    def backwards(self, orm):
        # Deleting model 'Tabular'
        db.delete_table(u'tabular_tabular')
