...
class DocumentUploadView(CreateView):
    template_name = 'tabular/document_upload.html'
...
class DocumentUpdateView(UpdateView):
    template_name = 'tabular/document_replace.html'
    pk_url_kwarg = 'docid'
...
@login_required
def document_remove(request, docid, template='tabular/document_remove.html'):
    try:
        ...
        if request.method == 'POST':
            document.delete()
            return HttpResponseRedirect(reverse("tabular_browse"))
        else:
